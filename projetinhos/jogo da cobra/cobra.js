...
const RecordeElement = document.querySelector(".Recorde");
...
RecordeElement.innerText = `Recorde: ${Recorde}`;
...
const initGame = () => {
    ...
    if (snakeX === foodX && snakeY === foodY) {
        ...
        Pontos++;
        Recorde = Pontos >= Recorde ? Pontos : Recorde; // if score > high score => high score = score

        localStorage.setItem("Recorde", Recorde);
        PontosElement.innerText = `Pontos: ${Pontos}`;
        RecordeElement.innerText = `Recorde: ${Recorde}`;
    }
